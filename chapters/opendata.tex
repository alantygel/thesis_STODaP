...
\section{Motivation: Why Open Data?}
\label{sec:why}
...
\caption[Data Spectrum as a definition of steps between open and close data.]{Data Spectrum as a definition of steps between open and close data. Source: \url{https://theodi.org/data-spectrum}}
...
%######################################################################
\section{The Open Data Landscape}
...
\caption[Model to analyse open budget initiatives.]{Model to analyse open budget initiatives. The four parts -- General Aspects, Publishing, Consumption and Context -- are interconnected, and composed by several dimensions. Icons:\href{http://www.flaticon.com/authors/icomoon}{Flaticon (CC)}.}
\label{fig:framework}
\end{center}
\end{figure*}
...
\section{The Problems of Open Data}
\label{sec:problems}
\cite{Roseira2016}
...
\subsection{The Problem of Open Data Capacities and Data Divide}
