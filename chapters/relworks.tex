...
This work was further extended by \citeonline{Knerr2006}, who proposed the Tagging Ontology, depicted in Figure~\ref{fig:tagging_ontology}.
...
The most recent attempt to build a tag ontology is the Modular Unified Tagging Ontology (MUTO)\footnote{\url{http://muto.socialtagging.org/core/v1.html}}, shown in Figure~\ref{fig:muto}, and described by~\citeonline{Lohmann2011}.
...
Regarding the related bibliography, it is necessary to highlight that the vast majority of scientific works about tagging and semantics focus on a different kind of context in relation to ours.
...
Figure \ref{fig:similarity} shows a distribution of the percentage of similar tags inside each ODP.
